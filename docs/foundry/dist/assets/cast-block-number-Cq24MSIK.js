import{j as e}from"./index-D5UbER3f.js";import t from"./rpc-url-option-Bdlv6sNx.js";import a from"./common-options-OsAHhg-o.js";import{u as r}from"./index-CZxYc6i7.js";const l=void 0;function s(i){const n={a:"a",code:"code",div:"div",em:"em",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.h2,{id:"cast-block-number",children:["cast block-number",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#cast-block-number",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
...
`,e.jsx(n.p,{children:"cast-block-number - Get the latest block number."}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"cast block-number"})," [",e.jsx(n.em,{children:"options"}),"]"]}),`
...
`,e.jsx(n.p,{children:"Get the latest block number."}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.a,{href:"/cast/reference/overview",children:"cast"}),", ",e.jsx(n.a,{href:"/cast/reference/cast-block",children:"cast block"})]})]})}function x(i={}){const{wrapper:n}={...r(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{x as default,l as frontmatter};
