...
`,e.jsx(n.p,{children:"cast-gas-price - Get the current gas price."}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"cast gas-price"})," [",e.jsx(n.em,{children:"options"}),"]"]}),`
...
`,e.jsx(n.p,{children:"Get the current gas price."}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.a,{href:"/cast/reference/overview",children:"cast"}),", ",e.jsx(n.a,{href:"/cast/reference/cast-basefee",children:"cast basefee"})]})]})}function x(i={}){const{wrapper:n}={...r(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{x as default,l as frontmatter};
