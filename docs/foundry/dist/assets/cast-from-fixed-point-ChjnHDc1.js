import{j as e}from"./index-D5UbER3f.js";import d from"./common-options-OsAHhg-o.js";import{u as r}from"./index-CZxYc6i7.js";const c=void 0;function s(i){const n={a:"a",code:"code",div:"div",em:"em",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.h2,{id:"cast-from-fixed-point",children:["cast from-fixed-point",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#cast-from-fixed-point",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
...
`,e.jsx(n.p,{children:"cast-from-fixed-point - Convert a fixed point number into an integer."}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"cast from-fixed-point"})," [",e.jsx(n.em,{children:"options"}),"] ",e.jsx(n.em,{children:"decimals"})," ",e.jsx(n.em,{children:"value"})]}),`
...
`,e.jsx(n.p,{children:"Convert a fixed point number into an integer."}),`
...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"/cast/reference/overview",children:"cast"})})]})}function h(i={}){const{wrapper:n}={...r(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{h as default,c as frontmatter};
