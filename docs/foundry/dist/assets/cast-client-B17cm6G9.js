import{j as e}from"./index-D5UbER3f.js";import r from"./rpc-url-option-Bdlv6sNx.js";import d from"./common-options-OsAHhg-o.js";import{u as t}from"./index-CZxYc6i7.js";const l=void 0;function s(i){const n={a:"a",code:"code",div:"div",em:"em",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.h2,{id:"cast-client",children:["cast client",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#cast-client",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
...
`,e.jsx(n.p,{children:"cast-client - Get the current client version."}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"cast client"})," [",e.jsx(n.em,{children:"options"}),"]"]}),`
...
`,e.jsx(n.p,{children:"Get the current client version."}),`
...
`,e.jsx(n.p,{children:e.jsx(n.a,{href:"/cast/reference/overview",children:"cast"})})]})}function x(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{x as default,l as frontmatter};
