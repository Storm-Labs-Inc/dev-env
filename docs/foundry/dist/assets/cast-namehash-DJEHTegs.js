import{j as e}from"./index-D5UbER3f.js";import r from"./common-options-OsAHhg-o.js";import{u as i}from"./index-CZxYc6i7.js";const c=void 0;function s(a){const n={a:"a",code:"code",div:"div",em:"em",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",...i(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.h2,{id:"cast-namehash",children:["cast namehash",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#cast-namehash",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
...
`,e.jsx(n.p,{children:"cast-namehash - Calculate the ENS namehash of a name."}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"cast namehash"})," [",e.jsx(n.em,{children:"options"}),"] ",e.jsx(n.em,{children:"name"})]}),`
...
`,e.jsx(n.p,{children:"Calculate the ENS namehash of a name."}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.a,{href:"/cast/reference/overview",children:"cast"}),", ",e.jsx(n.a,{href:"/cast/reference/cast-lookup-address",children:"cast lookup-address"}),", ",e.jsx(n.a,{href:"/cast/reference/cast-resolve-name",children:"cast resolve-name"})]})]})}function l(a={}){const{wrapper:n}={...i(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(s,{...a})}):s(a)}export{l as default,c as frontmatter};
