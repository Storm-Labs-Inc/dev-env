import{j as e}from"./index-D5UbER3f.js";import r from"./rpc-url-option-Bdlv6sNx.js";import d from"./common-options-OsAHhg-o.js";import{u as a}from"./index-CZxYc6i7.js";const o=void 0;function i(n){const s={a:"a",code:"code",div:"div",em:"em",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",...a(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.h2,{id:"cast-age",children:["cast age",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#cast-age",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
...
`,e.jsx(s.p,{children:"cast-age - Get the timestamp of a block."}),`
...
`,e.jsxs(s.p,{children:[e.jsx(s.code,{children:"cast age"})," [",e.jsx(s.em,{children:"options"}),"] [",e.jsx(s.em,{children:"block"}),"]"]}),`
...
`,e.jsx(s.p,{children:"Get the timestamp of a block."}),`
`,e.jsxs(s.p,{children:["The specified ",e.jsx(s.em,{children:"block"})," can be a block number, or any of the tags: ",e.jsx(s.code,{children:"earliest"}),", ",e.jsx(s.code,{children:"finalized"}),", ",e.jsx(s.code,{children:"safe"}),", ",e.jsx(s.code,{children:"latest"})," or ",e.jsx(s.code,{children:"pending"}),". Default to ",e.jsx(s.code,{children:"latest"}),"."]}),`
...
`,e.jsx(s.p,{children:"Get the timestamp of the latest block:"}),`
`,e.jsx(e.Fragment,{children:e.jsx(s.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:e.jsx(s.code,{children:e.jsxs(s.span,{className:"line",children:[e.jsx(s.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"cast"}),e.jsx(s.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" age"})]})})})}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(s.p,{children:"Get the timestamp of the genesis block:"}),`
`,e.jsx(e.Fragment,{children:e.jsx(s.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:e.jsx(s.code,{children:e.jsxs(s.span,{className:"line",children:[e.jsx(s.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"cast"}),e.jsx(s.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" age"}),e.jsx(s.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:" 1"})]})})})}),`
`]}),`
`]}),`
...
`,e.jsxs(s.p,{children:[e.jsx(s.a,{href:"/cast/reference/overview",children:"cast"}),", ",e.jsx(s.a,{href:"/cast/reference/cast-block",children:"cast block"}),", ",e.jsx(s.a,{href:"/cast/reference/cast-basefee",children:"cast basefee"})]})]})}function x(n={}){const{wrapper:s}={...a(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(i,{...n})}):i(n)}export{x as default,o as frontmatter};
